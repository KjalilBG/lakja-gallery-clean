...
export function HomeContactCard({ whatsappNumber }: HomeContactCardProps) {
  ...
  const whatsappHref = useMemo(() => {
    const finalMessage = [
      "Hola La Kja, vi su sitio en construcción y quiero info.",
  ...
  return (
    <section className="rounded-[32px] border border-slate-200 bg-white p-6 shadow-[0_16px_40px_rgba(15,23,42,0.06)]">
      <p className="text-xs font-extrabold uppercase tracking-[0.24em] text-slate-400">Contacto rápido</p>
      <h2 className="mt-3 text-3xl font-black tracking-tight text-slate-950">Escríbeme sin drama técnico</h2>
      <p className="mt-3 text-sm leading-7 text-slate-600">
        Déjame un nombre y una idea general. Te llevo directo a WhatsApp con el mensaje casi servido, como buffet pero de leads.
      </p>
      ...
      <div className="mt-5 grid gap-4">
        ...
        <textarea
          ...
          placeholder="Cuéntame qué necesitas: retrato, evento, branding, algo loco..."
