...
export function AlbumCard({
  ...
  if (variant === "showcase") {
    return (
      <Link
        ...
        className="group block overflow-hidden rounded-[26px] border border-slate-200 bg-white p-3 shadow-[0_8px_24px_rgba(15,23,42,0.05)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_18px_34px_rgba(15,23,42,0.08)]"
      >
        <div
        ...
        <div className="space-y-1 px-2 pb-2 pt-5">
          <h3 className="text-[2rem] font-black tracking-tight text-slate-950">{album.title}</h3>
  ...
  return (
    <Link
      href={actionHref ?? `/g/${album.slug}`}
      className="group block overflow-hidden rounded-[28px] border border-slate-200 bg-white p-4 shadow-[0_12px_28px_rgba(15,23,42,0.06)] transition hover:-translate-y-1 hover:shadow-[0_18px_35px_rgba(15,23,42,0.10)]"
    >
      <div
      ...
      <div className="space-y-4 px-2 pb-2 pt-5">
        <div className="space-y-1">
          <h3 className="text-2xl font-black tracking-tight text-slate-900">{album.title}</h3>
          <p className="text-xs font-extrabold uppercase tracking-[0.26em] text-slate-400">{formatDate(album.eventDate)}</p>
        </div>
        <div className="flex items-center justify-between gap-3">
          ...
          <span className="inline-flex h-11 w-11 items-center justify-center rounded-full border border-slate-200 text-slate-500 transition group-hover:border-lime-300 group-hover:text-slate-900">
