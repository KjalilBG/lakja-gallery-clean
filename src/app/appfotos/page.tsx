        ...
        <div className="grid gap-8 lg:grid-cols-[1.12fr_0.88fr] lg:items-center">
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-3 lg:max-w-xl">
              ...
              <Link
                href="/"
                className="inline-flex items-center justify-center rounded-full border border-slate-200 bg-slate-50 px-5 py-4 text-sm font-extrabold uppercase tracking-[0.16em] text-slate-700 transition hover:border-slate-300 hover:bg-white"
              >
                Ir a La Kja
              </Link>
            </div>
