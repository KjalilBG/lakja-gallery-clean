        ...
        <aside className="space-y-6 xl:sticky xl:top-28 xl:self-start">
          <section className="overflow-hidden rounded-[34px] border border-slate-200 bg-white shadow-[0_14px_35px_rgba(15,23,42,0.06)] dark:border-slate-700 dark:bg-slate-900">
            ...
            <div className="space-y-3 p-6">
              ...
              <h2 className="text-xl font-black tracking-tight text-slate-950 dark:text-white">{settings.shareTitle}</h2>
              <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">{settings.shareDescription}</p>
